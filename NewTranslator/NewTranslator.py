...
#КОМЕНТАРИЙ ДЛЯ УЧИТЕЛЯ:объективно работа выполнена на 6/10 так как не работает аж целых 2 фунции и 3ья не работает до конца на я очень старался и долго потел над этим заданием это был крайне интересный опыт я бы поставил себе за такую работу не больше тройки

#нормально не работает:проговаривание,проверка знаний и замена слова работает но я не смог сделать так чтобы он ещ и в файле сохранялось у меня были мысли близкие к разгадке но они не сработали
